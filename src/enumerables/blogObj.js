export const blogsArray = [
    {
        id: "b4",
        title: "Controlled dropdown selection with React, Redux, and Semantic-UI-React",
        desc: "In this post, I walk through managing a dropdown select from Semantic UI React. It's a controlled form with the option for users to add additional items.",
        link: "https://medium.com/@wley3337/controlled-dropdown-selection-with-react-redux-and-semantic-ui-react-6a3b2b158659"
    },
    {
        id: "b1",
